...
<style>
  ...
  footer {text-align:center; padding:20px; background:#0d1b4c;}/* Animation */ @keyframes fadeInUp { 0% {opacity: 0; transform: translateY(20px);} 100% {opacity: 1; transform: translateY(0);} } .animated-intro { text-align:center; animation: fadeInUp 2s ease-in-out; } </style>
